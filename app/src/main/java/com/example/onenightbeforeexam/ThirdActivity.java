...
//        empEmailTV = findViewById(R.id.empEmailTV);
//        empAgeTV = findViewById(R.id.empAgeTV);
//        empGenderTV = findViewById(R.id.empGenderTV);
//        empHobbiesTV = findViewById(R.id.empHobbiesTV);
//        empCountryTV = findViewById(R.id.empCountryTV);
//        empExperienceTV = findViewById(R.id.empExperienceTV);
//        empQualificationTV = findViewById(R.id.empQualificationTV);
//        empExpSalaryTV = findViewById(R.id.empExpSalaryTV);
//        empPrevCompaniesTV = findViewById(R.id.empPrevCompaniesTV);
//
//    }
//
